    ...
    switch (userState[userId]) {
        ...
        case "ex-aluno":
            ...
            if (text === "1") {
                ...
                message.reply("Escolha um dos cursos abaixo:\n\n1️⃣ Desenvolvimento FullStack\n2️⃣ QA (Analista de Qualidade)\n3️⃣ Análise de Dados");
            }
            else if (text === "2") {
                message.reply("Perfeito! Você será encaminhado para um atendente.");
        ...
        case "dev":
            ...
            if (text === "1") {
                ...
                message.reply(`Aqui estão mais informações sobre o curso ${cursos.desenvolvimentoFullStack.nome}:\n\n` +
                ...
                // Vai para o curso QA
                userState[userId] = "qa";
                message.reply(`Aqui estão mais informações sobre o curso ${cursos.qa.nome}:\n\n` +
        ...
        case "detalhes-curso":
            ...
            // Quando o usuário digitar "1" para se inscrever no curso
                ...
                message.reply("Parabéns! 🎉 Você foi inscrito no curso.\n\n" +
        ...
        case "matricula":
            ...
            message.reply("Sua matrícula foi confirmada. Se precisar de mais ajuda, estou à disposição!");
            break;
    }
}));
